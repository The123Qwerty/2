...
HTMLActuator.prototype.newTilePopup = function(inner, text)
{
  ...
  rarityBox.style.left = (window.innerWidth/2) + "px";
  rarityBox.style.top = '0%';
  rarityBox.style.width = '250px';
  ...
  rarityBox.style.fontSize = '20px';
  rarityBox.style.color = '#f9f6f2';
  //rarityBox.style.padding = '70px 5px';
