...
GameManager.prototype.addRandomTile = function () {
  if (this.grid.cellsAvailable()) {
    ...
    if (/[A-Z]/.test(text[0]) || text == "." || text == '\xa0' || text == "-") {
      for (let i = 0; i < 3; i++) {
...
GameManager.prototype.move = function (direction) {
  ...
  if (this.isGameTerminated() || this.actuator.animationRunning || this.actuator.menuOpen) return; // Don't do anything if the game's over or an animation is running or the menu is open
