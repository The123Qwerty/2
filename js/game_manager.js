...
GameManager.prototype.addRandomTile = function () {
  ...
  if (this.grid.cellsAvailable()) {
    var value = Math.random() < 0.999999999 ? Math.random() < 0.999999992 ? Math.random() < 0.999999995 ? Math.random() < 0.99999999 ? Math.random() < 0.99999998 ? Math.random() < 0.999999975 ? Math.random() < 0.999999971428571 ? Math.random() < 0.9999999666 ? Math.random() < 0.99999996 ? Math.random() < 0.99999995 ? Math.random() < 0.9999999333 ? Math.random() < 0.9999999 ? Math.random() < 0.9999998 ? Math.random() < 0.9999996 ? Math.random() < 0.999999375 ? Math.random() < 0.999999 ? Math.random() < 0.9999984 ? Math.random() < 0.9999975 ? Math.random() < 0.999996 ? Math.random() < 0.99999444 ? Math.random() < 0.999991667 ? Math.random() < 0.99998666 ? Math.random() < 0.99998 ? Math.random() < 0.9999666 ? Math.random() < 0.9999333 ? Math.random() < 0.9999 ? 1: 99991: 99992: 99993: 99994: 99995: 99996: 99997: 99998: 99999: 999910: 999911: 999912: 999913: 999914: 999915: 999916: 999917: 999918: 999919: 999920: 999921: 999922: 999923: 999924: 999925: 999926;
